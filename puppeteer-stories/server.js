...
function generateStoryHTML(template, data) {
    ...
    if (template === 'voce-sabia') {
        return '<!DOCTYPE html><html><head><meta charset="UTF-8">' + baseStyles + '<style>.story{width:1080px;height:1920px;background:linear-gradient(180deg,' + corPrimaria + ' 0%,' + corFundo + ' 100%);padding:120px 80px;display:flex;flex-direction:column;}.icon-top{font-size:160px;text-align:center;margin-bottom:80px;}.pergunta{font-family:Playfair Display,serif;font-size:88px;color:' + corSecundaria + ';text-align:center;margin-bottom:100px;line-height:1.3;}.resposta{background:rgba(212,175,55,0.15);border-left:12px solid ' + corSecundaria + ';padding:60px;margin-bottom:100px;}.resposta p{color:white;font-size:56px;line-height:1.5;}.destaque{background:' + corSecundaria + ';color:' + corFundo + ';padding:50px 60px;border-radius:30px;text-align:center;font-weight:700;font-size:60px;}.footer{margin-top:auto;text-align:center;padding-top:80px;border-top:2px solid rgba(212,175,55,0.3);}.advogado{color:white;font-size:48px;font-weight:600;}.oab{color:#888;font-size:40px;margin-top:12px;}.cta{color:' + corSecundaria + ';font-size:44px;margin-top:60px;}</style></head><body><div class="story"><div class="icon-top">⚖️</div><div class="pergunta">' + pergunta + '</div><div class="resposta"><p>' + resposta + '</p></div><div class="destaque">' + destaque + '</div><div class="footer"><div class="advogado">' + nomeAdvogado + '</div><div class="oab">' + oab + '</div><div class="cta">↑ ' + cta + '</div></div></div></body></html>';
    }
    ...
    if (template === 'bullets') {
        ...
        return '<!DOCTYPE html><html><head><meta charset="UTF-8">' + baseStyles + '<style>.story{width:1080px;height:1920px;background:linear-gradient(180deg,#0f172a 0%,#1e293b 100%);padding:100px 72px;display:flex;flex-direction:column;}.badge{background:' + corSecundaria + ';color:white;font-size:36px;font-weight:700;padding:20px 40px;border-radius:80px;align-self:flex-start;margin-bottom:60px;text-transform:uppercase;letter-spacing:4px;}.headline{font-family:Montserrat,sans-serif;font-size:80px;font-weight:800;color:white;line-height:1.2;margin-bottom:80px;}.headline span{color:' + corSecundaria + ';}.bullets{flex:1;}.bullet{display:flex;align-items:flex-start;gap:48px;margin-bottom:60px;background:rgba(255,255,255,0.05);padding:48px;border-radius:40px;}.bullet-icon{width:128px;height:128px;background:linear-gradient(135deg,' + corSecundaria + ',#16a34a);border-radius:32px;display:flex;align-items:center;justify-content:center;font-size:64px;flex-shrink:0;}.bullet-text{color:white;font-size:48px;line-height:1.4;}.bullet-text strong{color:' + corSecundaria + ';display:block;margin-bottom:8px;font-size:52px;}.cta-box{background:linear-gradient(135deg,' + corSecundaria + ',#16a34a);padding:60px;border-radius:48px;text-align:center;margin-top:auto;}.cta-box p{color:white;font-weight:700;font-size:52px;}.cta-box span{color:rgba(255,255,255,0.8);font-size:40px;display:block;margin-top:20px;}</style></head><body><div class="story"><div class="badge">✓ ' + area + '</div><div class="headline">' + headline + '</div><div class="bullets">' + bulletsHTML + '</div><div class="cta-box"><p>' + cta + '</p><span>↑ Toque no link da bio</span></div></div></body></html>';
    }
