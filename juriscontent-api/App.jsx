          ...
          <div className="flex mb-6 bg-slate-900/50 rounded-lg p-1">
            <button
              ...
              className={`flex-1 py-2.5 rounded-md text-sm font-medium transition-all ${
                modo === 'login' ? 'bg-amber-500 text-white' : 'text-slate-400 hover:text-white'
              }`}
            >
              Entrar
            </button>
            <button
              ...
              className={`flex-1 py-2.5 rounded-md text-sm font-medium transition-all ${
                modo === 'registro' ? 'bg-amber-500 text-white' : 'text-slate-400 hover:text-white'
              }`}
            >
              Criar Conta
            </button>
                ...
                {minhasImagens.map((img) => (
                  <div
                    ...
                    className={`relative cursor-pointer rounded-lg overflow-hidden border-2 transition-all ${
                      selecionada?.id === img.id ? 'border-amber-400 ring-2 ring-amber-400/30' : 'border-slate-700 hover:border-slate-600'
                    }`}
                  >
        ...
        <div className="p-6 space-y-5">
          {msg.texto && (
            <div className={`p-3 rounded-lg text-sm flex items-center gap-2 ${
              msg.tipo === 'sucesso' ? 'bg-green-500/10 text-green-400' : 'bg-red-500/10 text-red-400'
            }`}>
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex items-center justify-between mb-8">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-3xl font-bold text-white">Criador de Conteúdo Jurídico</h1>
              <p className="text-slate-300">Olá, {user.nome}</p>
            </div>
          </div>
                      ...
                      {DADOS.formatosImagem.map((formato) => (
                        ...
                        >
                          ...
                          <div className={`font-medium text-sm mb-1 ${
                            formatoImagem === formato.id ? 'text-amber-400' : 'text-white'
                          }`}>
                            {formato.nome}
                          </div>
